...
static struct key keys_full[] = {
  ...
  {"š", "Š", 1.0, Code, KEY_LEFTBRACE, &layouts[ComposeS]},
  {"đ", "Đ", 1.0, Code, KEY_RIGHTBRACE, &layouts[ComposeD]},
  {"ž", "Ž", 1.0, Code, KEY_BACKSLASH, &layouts[ComposeZ]},
  {"", "", 0.0, EndRow},
  ...
  {"č", "Č", 1.0, Code, KEY_SEMICOLON, &layouts[ComposeC]},
  {"ć", "Ć", 1.0, Code, KEY_APOSTROPHE, &layouts[ComposeC]},
